	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			if ( $op001_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $op001_description; /* WPCS: xss ok. */ ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->

		<nav id="site-navigation" class="main-navigation">
			<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false"><?php esc_html_e( 'Primary Menu', 'op001' ); ?></button>
			<?php
			wp_nav_menu( array(
